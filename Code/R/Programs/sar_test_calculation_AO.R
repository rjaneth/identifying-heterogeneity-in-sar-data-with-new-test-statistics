...
# Function to calculate Type II Error Rate
...
for (s in sample.size) {
  ...
  for (r in 1:R) {
    # Generate samples under the alternative hypothesis
...
# Calculate p-values under the alternative hypothesis
mu_W <-  mean_entropy1  
...
alpha_nominal <- 0.05
type_II_error_rate <- calculate_type_II_error_rate(p_values, alpha_nominal)
