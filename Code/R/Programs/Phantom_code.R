...
z.up.le.b <- rGI0(n=sum(1-p.up.le), 
                  p_alpha=-2, p_mu=1, p_Looks=2)
mean(z.up.le.b)

z.up.le.w <- rGI0(n=sum(p.up.le), 
                  p_alpha=-10, p_mu=9, p_Looks=2)
mean(z.up.le.w)
z.up.le <- p.up.le
...
z.up.ri.b <- rGI0(n=sum(1-p.up.ri), 
                  p_alpha=-2, p_mu=50, p_Looks=2)
mean(z.up.ri.b)
z.up.ri.w <- rGI0(n=sum(p.up.ri), 
                  p_alpha=-2, p_mu=5, p_Looks=2)
mean(z.up.ri.w)
z.up.ri <- p.up.ri
...
z.bo.ri.b <- rGI0(n=sum(1-p.bo.ri), 
                  p_alpha=-6, p_mu=250, p_Looks=2)
mean(z.bo.le.b)
z.bo.ri.w <- rGI0(n=sum(p.bo.ri), 
                  p_alpha=-3, p_mu=10, p_Looks=2)
mean(z.bo.le.w)
z.bo.ri <- p.bo.ri
...
z.bo.le.b <- rGI0(n=sum(1-p.bo.le), 
                  p_alpha=-3, p_mu=20, p_Looks=2)
mean(z.bo.le.b)
z.bo.le.w <- rGI0(n=sum(p.bo.le), 
                  p_alpha=-9, p_mu=80, p_Looks=2)
mean(z.bo.le.w)
z.bo.le <- p.bo.le
...
save(Z, file="./Data/Phantom.Rdata")
