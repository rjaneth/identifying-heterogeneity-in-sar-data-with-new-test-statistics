...
Figure&nbsp;\ref{fig:Plot_density} shows the empirical test statistic densities for different sample sizes using \(\widetilde{H}_{\text{AO}}\) estimator, and Table&nbsp;\ref{tab:table_stat_combined} summarizes the main descriptive statistics, including mean, 
...
\[
\varepsilon=\frac{\widetilde{H}-H_{\Gamma_{\text{SAR}}}}{\widehat\sigma}.
\]
...
This phantom was proposed by&nbsp;\citet{Gomez2017}.
The observations are independent draws from the $G^0_I$ distribution, with $L = 5$ and varying $\alpha$. 
...
## SAR Data
<!-- ACF Don't use "real" unless it refers to the real part of a complex value -->

We evaluated the proposed test statistics using three SAR images: one of the coast of Jalisco, Mexico, and two of Illinois, USA, acquired by the Sentinel-1B satellite operating in C-band, with VV polarization, intensity format, \(L=18\) and \(L=36\)  nominal looks.
